...
const target = 'C:/Users/Rax/Desktop/Delivery_app_web/src/pages/forgot-something/ForgotSomethingBookingPage.jsx';

const jsxContent = `import { useEffect, useMemo, useState } from 'react'
import {
  Archive,
  ArrowLeft,
  ArrowRight,
...
fs.writeFileSync(target, jsxContent, 'utf8');
console.log('ForgotSomethingBookingPage.jsx updated with desktop design!');
