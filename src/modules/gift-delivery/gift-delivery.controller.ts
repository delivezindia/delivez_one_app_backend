...
export const getQuote: RequestHandler = (_req, _res) => {
  throw new AppError(403, 'Gift & Surprise Delivery service is discontinued and no longer available for booking.');
};

export const createBooking: RequestHandler = async (_req, _res) => {
  throw new AppError(403, 'Gift & Surprise Delivery service is discontinued and no longer available for booking.');
};
